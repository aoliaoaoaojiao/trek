...
func NewRichWidget(parent *RichWidget, element *types.Element) *RichWidget {
	// 首先创建基础Widget
...
func (rw *RichWidget) getValidTextFromWidgetAndChildren(element *types.Element) string {
